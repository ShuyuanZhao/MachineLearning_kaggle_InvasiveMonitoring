...
# 
    ...
    x_model = GlobalAveragePooling2D(name='New_add_pool_'+str(final_stage))(x)

    x_model = Dense(1024, activation='relu',name='New_add_fc1_Dense')(x_model)
    x_model = Dropout(0.5, name='dropout_1')(x_model)

    x_model = Dense(256, activation='relu',name='New_add_fc2_Dense')(x_model)
    x_model = Dropout(0.5, name='dropout_2')(x_model)
    predictions = Dense(1, activation='sigmoid',name='New_add_output_layer')(x_model)
